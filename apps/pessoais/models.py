...
class Receita(models.Model):  
    ...
    status = models.CharField(max_length=1, choices=STATUS_RECEITA, blank=False, null=False, default='1')
...
class Despesa(models.Model):
    ...
    data = models.DateField(default=date.today, blank=True)
    status = models.CharField(max_length=1, choices=STATUS_DESPESA, blank=False, null=False, default='1')
